...
/**
 *  Verify if the value of a jBPM variable is NULL and
 ...
 */
public class JtVariableIsNull extends JtObject {
...
public void execute(ExecutionContext context) throws Exception {
    ...
    try {
        ...
        if (variable == null) {
            handleTrace ("JtVariableIsNull(true): leaving the Node to "
                    + trueTransition);
            context.leaveNode (trueTransition);


        } else {
            handleTrace ("JtVariableIsNull(false): leaving the Node to "
                    + falseTransition);
